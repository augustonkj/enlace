...
const TOURQ = [
  { t: "Bem-vindo ao Enlace", b: "O Enlace reúne quatro janelas: Teoria Ator-Rede, Diagrama, Análise Qualitativa e Análise Quantitativa. Tudo começa em branco; cada janela tem um botão Exemplo (no menu Projeto) se você quiser ver um modelo pronto." },
...
export default function App() {
  ...
  const salvarTudo = async () => {
    try {
      ...
      const payload = { __enlace: 1, savedAt: new Date().toISOString(), tar, qual, geral };
        ...
        <div role="dialog" aria-modal="true" aria-label="Sobre o Enlace" onClick={() => setShowAbout(false)} style={{ position: "fixed", inset: 0, background: "rgba(20,30,38,.5)", display: "flex", alignItems: "center", justifyContent: "center", padding: 16, zIndex: 1300 }}>
          <div ref={aboutRef} onClick={(e) => e.stopPropagation()} style={{ background: "#fff", borderRadius: 12, maxWidth: 560, width: "100%", maxHeight: "86vh", overflow: "auto", boxShadow: "0 12px 40px rgba(0,0,0,.3)", padding: "24px 26px" }}>
            ...
            <p style={{ margin: "0 0 10px", fontSize: 13.5, color: "#46555f", lineHeight: 1.6 }}>
              O Enlace reúne quatro janelas para pesquisa qualitativa e quantitativa: Teoria Ator-Rede e Diagrama (redes da Teoria Ator-Rede e mapa conceitual), Análise Qualitativa (codificação de texto em códigos e categorias) e Análise Quantitativa (testes estatísticos).
            </p>
            <p style={{ margin: "0 0 10px", fontSize: 13.5, color: "#46555f", lineHeight: 1.6 }}>
